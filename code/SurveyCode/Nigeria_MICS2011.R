########################################################
###
### Analysis of 2011 MICS
### Updated October 9, 2018

####################################################
# -- load harmonized data for Nigeria MICS 2011 -- #
####################################################
load("Data/MICS/ngwm4.RData")
surveyID<-"ngwm4"
...
write_csv(as.data.frame(final),
          "Data/Processed/Nigeria/Processed_Nigeria2011.csv")
