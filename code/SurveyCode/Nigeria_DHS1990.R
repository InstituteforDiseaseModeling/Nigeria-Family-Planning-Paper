...
state_key<-unique(key[,c("state","row_num")])
dim(state_key)
...
# # the above code assigns the original recorded state as cluster.
# # to test the alternative for cluster 1402, run the following:
# dhs$state[dhs$v001==1402] <- 'kogi'
...
write_csv(as.data.frame(final),
          "Data/Processed/Nigeria/Processed_Nigeria1990.csv")
